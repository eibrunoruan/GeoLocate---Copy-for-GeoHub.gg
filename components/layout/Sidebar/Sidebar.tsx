    ...
    <StyledSidebar>
      <div className="sidebar">
        ...
        <div className="sidebar-footer">
          <a className="support-link" href="https://www.buymeacoffee.com/GeoLocategame" target="_blank" rel="noreferrer">
            <HeartIcon />
            <span>Support</span>
          </a>
          <div className="social-links">
            <a className="social-link" href="https://github.com/benlikescode/GeoLocate" target="_blank" rel="noreferrer">
